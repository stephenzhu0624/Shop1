    ...
    <div class="container">
        ...
        <div class="col-md-9 content_right">
            <div class="dreamcrub">
                ...
                <ul class="previous">
                    <li><a href="./adminAddProduct">添加商品</a></li>
                </ul>
                <div class="clearfix"></div>
            </div>
            <table class="table table-responsive">
                ...
                <c:forEach items="${products}" var="p">
                    <tr>
                        <td width="40%"><img src="${p.p1 }" width="40%" height="20%"></td>
                        <td width="20%">${p.proName }</td>
                        <td width="20%">${p.price }</td>
                        <td width="20%"><a href="./productDetail?productid=${p.productid}">详细信息</a>&nbsp;<a href="./deleteFromProduct?productid=${p.productid}">删除</a></td>
                    </tr>
                </c:forEach>
            </table>
        </div>
