            ...
            <form action="./updateProductDetail" method="post">
                <table class="table table-responsive">
                    ...
                    <c:forEach items="${product}" var="p">
                        <tr>
                            <td>商品ID</td>
                            <td>${p.productid}<input type="text" size="50" hidden="hidden" name="productid" value="${p.productid}"></td>
                        </tr>
                        <tr>
                            <td>商品名</td>
                            <td><input type="text" size="50" name="proName" value="${p.proName}"></td>
                        </tr>
                        <tr>
                            <td>商品图片1路径</td>
                            <td><input type="text" size="50" name="p1" value="${p.p1 }"></td>
                        </tr>
                        <tr>
                            <td>商品图片2路径</td>
                            <td><input type="text" size="50" name="p2" value="${p.p2 }"></td>
                        </tr>
                        <tr>
                            <td>商品图片3路径</td>
                            <td><input type="text" size="50" name="p3" value="${p.p3}"></td>
                        </tr>
                        <tr>
                            <td>单价</td>
                            <td><input type="text" size="50" name="price" value="${p.price}"></td>
                        </tr>
                        <tr>
                            <td>简介</td>
                            <td><input type="text" size="50" name="quickOverview" value="${p.quickOverview}"></td>
                        </tr>
                        <tr>
                            <td>商品描述</td>
                            <td><input type="text" size="50" name="productDescription" value="${p.productDescription}"></td>
                        </tr>
                        <tr>
                            <td>附加信息</td>
                            <td><input type="text" size="50" name="addInformation" value="${p.addInformation}"></td>
                        </tr>
                        <tr>
                            <td>评价</td>
                            <td><input type="text" size="50" name="reviews" value="${p.reviews}"></td>
                        </tr>
                        <tr>
                            <td>类型</td>
                            <td><input type="text" size="50" name="type" value="${p.type}"></td>
                        </tr>
                    </c:forEach>
                </table>
